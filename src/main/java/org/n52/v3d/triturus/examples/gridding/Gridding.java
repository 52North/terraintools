...
public class Gridding
{
    public static void main(String args[]) 
    {
        ...
        try {
            lPointList = lReader.readFromFile("data/test.xyz");
            ...
            if (N > 0) {
                ...
                IoElevationGridWriter lGridWriter = new IoElevationGridWriter(IoElevationGridWriter.X3D);
                lGridWriter.writeToFile(lResGrid, "data/test.x3d");
